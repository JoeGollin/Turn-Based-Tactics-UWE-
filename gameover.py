...
class GameOver(GameState):
    ...
    def __init__(self, gamedata: GameData) -> None:
        ...
        self.loser_text = pyasge.Text(self.status_font, "TEAM 2 WINS")
        self.loser_text.colour = pyasge.COLOURS.BLACK
        self.loser_text.position = (512 - self.loser_text.width / 2, 400)
    ...
    def render(self, game_time: pyasge.GameTime) -> None:
        ...
        self.data.renderer.render(self.loser_text)
